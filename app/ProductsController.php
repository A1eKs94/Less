	...
	if (isset($_POST['action'])) {
		...
		switch ($_POST['action']) {
			...
			case 'crear_producto':
				...
				$brand_var = $_POST['brand_id'];

				$productsController = new ProductsController();

				$productsController->create($name_var,$slug_var,$description_var,$features_var,$image_var, $brand_var);	
...
class ProductsController 
{
	...
	public function create($name_var,$slug_var,$description_var,$features_var,$image_var, $brand_var)
	{
